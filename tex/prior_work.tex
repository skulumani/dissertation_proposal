...
\only<3>{
\begin{center}
  \animategraphics[autoplay,loop,width=0.5\textwidth]{30}{figures/2016AAS/animation/castalia/IMG}{00001}{00999}~\hfill
...
\begin{center}
  \animategraphics[autoplay,loop,width=0.5\textwidth]{30}{figures/2016AAS/animation/body/IMG}{00001}{01499}~\hfill
  \animategraphics[autoplay,loop,width=0.5\textwidth]{30}{figures/2016AAS/animation/inertial/IMG}{00001}{01499}
\end{center}
...
\animategraphics[autoplay,loop,width=0.5\textwidth]{8}{figures/2016ACC/animation/single_noavoid/single_noavoid-}{0}{99}~
\animategraphics[autoplay,loop,width=0.5\textwidth]{8}{figures/2016ACC/animation/single_avoid/single_avoid-}{0}{99}
...
\begin{figure}
    \centering
    \animategraphics[autoplay,loop,width=0.5\textwidth]{8}{figures/2016ACC/animation/multiple_avoid/multiple_avoid-}{0}{99}
\end{figure}
