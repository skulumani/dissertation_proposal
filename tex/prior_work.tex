...
\begin{frame}%------------------------------------------------%
    ...
    \end{itemize}
    \begin{center}
        \only<1-2>{\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{2015AAS/reach_trajectory}  }
        \visible<3->{\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{2015AAS/reach_transfer}  }
        \visible<2->{\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{2015AAS/poincare_compare} }
    \end{center}
